...
function display_brand(input) {
  ...
  for (i = 0; i < check.length; i++) {
     check[i].style.display = "none";
     check_2[i].style.backgroundColor = "#FFFFFF";
  }

  if (name.style.height === "0vh") {
    name.style.visibility = "visible";
    name.style.height = "42vh";
...
function display_navigation(input) {
  var name = document.getElementById(input);
  var height = document.getElementById('static_core_mobile')

  if (name.style.height === "0vh") {
    name.style.visibility = "visible";
    name.style.height = "21vh"
    height.style.height = "42vh";
